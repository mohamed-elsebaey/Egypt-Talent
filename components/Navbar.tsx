...
const Navbar = () => {
  return (
    // <div className="fixed top-0 left-0 right-0 my-5 mx-[100px] rounded-full text-[#FFFFFF] bg-gradient-to-r from-customBlue to-customPink max-w-[1600px]">
    <div className="my-5 ssm:mx-[100px] mx-[50px] rounded-full text-[#FFFFFF] bg-gradient-to-r from-customBlue to-customPink max-w-[1600px]">
