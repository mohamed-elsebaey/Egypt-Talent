import bg1 from "@/public/Background1440px.jpg"
export const Hero = () => {
  return (
    <div
      className="relative w-[100%] bg-cover bg-center bg-no-repeat -mt-36 "
      style={{ backgroundImage: `url(${bg1.src})` }}
    >
      <div className="ssm:mx-[100px] mx-[50px] sm:py-[90px] py-[60px] px-2 flex flex-col items-center gap-5 text-center z-1 mt-48">
